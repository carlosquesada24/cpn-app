    ...
    <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            {/* <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    ...
                    <Link to={"/inventory-count-form/"} className="flex items-center justify-center rounded-lg text-white bg-green-700 block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Contar</Link>
                    <div className="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <div id="actionsDropdown" className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                            <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                                <li>
                                    <a href="#" className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Editar en masa</a>
                                </li>
                            </ul>
                            <div className="py-1">
                                <a href="#" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Eliminar todos</a>
                            </div>
                        </div>
                            ...
                            <td className="px-4 py-3 flex items-center justify-end">
                                ...
                                {openDropdownId === item.id && (
                                    <div id="apple-imac-27-dropdown" className=" z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul className=" text-sm text-gray-700 dark:text-gray-200" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <Link to={"/inventory-count-form/" + item.id} className="block py-2 px-4 hover:bg-gray-100 dark:bg-primary-700 dark:hover:bg-gray-600 dark:hover:text-white">Contar</Link>
                                            </li>
                                            <li>
                                        ...
                                        <div className="">
                                            <a href="#" className="block py-2 px-4 text-sm bg-red-600 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Eliminar</a>
                                        </div>
                                    </div>
                                )}
