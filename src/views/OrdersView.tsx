    ...
    return (
        ...
        <div className="pt-6">
          ...
          <div className="mt-4 flex items-center justify-between gap-4">
            <p className="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">Enviada</p>
...
<div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <Card order={{name: "Orden 1 - 1° semana Agosto"}} />
     <Card order={{name: "orden 2"}}/>
       <Card order={{name: "orden 3"}}/>
